...
class GatewayCustomDomainsInner(BaseModel):
    """
    The custom domain that the API Gateway instance should listen on. 
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The domain name of the distribution.")
    certificate_id: Optional[StrictStr] = Field(default=None, description="The ID of the certificate to use for the distribution.", alias="certificateId")
    __properties: ClassVar[List[str]] = ["name", "certificateId"]
