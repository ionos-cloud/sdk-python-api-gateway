...
from ionoscloud_api_gateway.api_response import ApiResponse, T as ApiResponseT
import ionoscloud_api_gateway.models
from ionoscloud_api_gateway import rest
from ionoscloud_api_gateway.exceptions import (
    ApiValueError,
    ApiException,
    ApiFailedRequest,
    ApiTimeout,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'ionos-cloud-sdk-python/v1.0.0-beta.2'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ionoscloud_api_gateway.models, klass)
